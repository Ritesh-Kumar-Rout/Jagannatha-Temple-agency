...
const AttractionModal: React.FC<AttractionModalProps> = ({ attraction, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-y-auto custom-scrollbar overscroll-contain" data-lenis-prevent="true">
      {/* Backdrop */}
      <div 
        className="fixed inset-0 bg-festival-deep/80 backdrop-blur-md animate-in fade-in duration-300"
        onClick={onClose}
      ></div>

      {/* Modal Container */}
      <div className="flex min-h-full items-center justify-center p-4 md:p-8">
        <div className="relative w-full max-w-5xl bg-[#fffbf0] rounded-[3rem] overflow-hidden shadow-2xl flex flex-col md:flex-row animate-in zoom-in-95 slide-in-from-bottom-10 duration-500 gpu-accel my-8">
