...
const RitualDetailsModal: React.FC<RitualDetailsModalProps> = ({ ritual, onClose }) => {
  ...
  return (
    <div 
      className="modal-overlay fixed inset-0 z-[1000] bg-black/60 backdrop-blur-md transition-all duration-300 animate-in fade-in overflow-y-auto custom-scrollbar stop-propagation"
      onClick={onClose}
      data-lenis-prevent="true"
    >
      <div className="flex min-h-full items-center justify-center p-0 md:p-10">
        <div 
          className="modal-content modal-content-premium relative bg-white w-full h-full md:rounded-3xl border-festival-cream border-4 overflow-hidden shadow-2xl flex flex-col animate-in slide-in-from-bottom-10 gpu-accel max-w-5xl"
        ...
        >
          ...
          {/* Body */}
          <div className="p-6 md:p-12" data-lenis-prevent="true">
            {/* Title Section */}
